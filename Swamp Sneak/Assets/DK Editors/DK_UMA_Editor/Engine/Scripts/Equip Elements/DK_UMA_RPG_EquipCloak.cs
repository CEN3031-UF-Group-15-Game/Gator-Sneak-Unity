...
public class DK_UMA_RPG_EquipCloak : MonoBehaviour {
	...
	public static void EquipSlotElement ( DKSlotData _slot, DKOverlayData _overlay, DK_RPG_UMA _DK_RPG_UMA, ColorPresetData ColorPreset, Color color, string Layer, string LayersAction, ColorPresetData Opt1,  ColorPresetData Opt2 ){
		...
		if ( _slot != null ){
			...
			if ( _overlay ) {
				...
				if ( _overlay 
					...
					if (  ColorPreset == null ){
						...
						_DK_RPG_UMA._Equipment._Cloak.ColorPreset = _overlay.ColorPresets[ran2];
					}
					else {
						color = ColorPreset.PresetColor;
						_DK_RPG_UMA._Equipment._Cloak.ColorPreset = ColorPreset;
					}
				}
			}
			...
			// opt 1 & 2 colors
			_DK_RPG_UMA._Equipment._Cloak.Opt01Color = Opt1;
			_DK_RPG_UMA._Equipment._Cloak.Opt02Color = Opt2;
			#endregion Equipment
